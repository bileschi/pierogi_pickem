...
if __name__ == "__main__":
    ...
    # Fill the games object for players who use ESPN.  For these picks we have
    # to do things a little backwards.  We look to see if they got the game
    # right, and then we back out their pick.
    for game in games:
